...
final class ProductImportColumns
{
    ...
    public static function labelsPl(): array
    {
        return [
            ...
            'primary_category_code' => 'Основная категория (код)',
            'category_codes' => 'Категории (коды через запятую)',
            'catalog_codes' => 'Каталоги (коды через запятую)',
            'size_grid_code' => 'Пресет кнопок размера (код)',
            'size_chart_preset_code' => 'Пресет таблицы мерок (код)',
            ...
            'variant_size' => 'Размер варианта (код из пресета)',
