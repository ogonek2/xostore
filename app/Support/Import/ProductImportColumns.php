...
final class ProductImportColumns
{
    ...
    public static function descriptions(): array
    {
        return [
            ...
            'size_chart_preset_code' => 'Пресет таблицы мерок в сантиметрах (обхват груди, талии, бёдер) — отдельный блок на странице товара. Для одежды — да, для сумок и аксессуаров обычно не нужен. Код или название из «Пресеты таблиц мерок».',
    ...
    public static function examples(): array
    {
        return [
            ...
            'size_chart_preset_code' => 'dresses_women',
            'base_price' => '1290',
